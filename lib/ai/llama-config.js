...
export const LLAMA_MODEL_CONFIG = {
  ...
  // Task-specific configurations (FREE TIER OPTIMIZED)
  CASE_GENERATION: {
    temperature: 0.3,        // Lower for consistent financial logic
    max_tokens: 3000,        // Reduced for free tier limits
  ...
  FINANCIAL_MODELING: {
    ...
    max_tokens: 4000,        // Reduced for free tier limits
    top_p: 0.9,             // Focused sampling for accuracy
    frequency_penalty: 0.05, // Minimal penalty for formula consistency
    presence_penalty: 0.0,   // No penalty - formulas should be consistent
    description: "Optimized for detailed financial model generation with VP/MD validation"
  },
  
  TEMPLATE_GENERATION: {
    temperature: 0.25,       // Low-medium for structured templates
    max_tokens: 2500,        // Reduced for free tier limits
...
- Apply proper number formatting (no strings for numeric values)
