...
export const LLAMA_MODEL_CONFIG = {
  // Model identifier - Qwen2.5 72B (excellent at following JSON schemas)
  ...
  CASE_GENERATION: {
    ...
    max_tokens: 2000,        // Much smaller for simple JSON output
    top_p: 0.9,             // Focused output
    frequency_penalty: 0.0,  // No penalty for consistent JSON structure
    presence_penalty: 0.0,   // No penalty for required fields
    description: "Optimized for simple JSON compliance"
  },
